...
class Crypto {
	 ...
	 */
	private $pbUserKey			=	array(27,-93,88,-33,13,20,125,45,-45,120,133,23,50,-48,78,24);					//	사용자키
	private $IV					=	array('W',2,'E',0,'B',1,'T',4,'I',0,'C',4,'K',1,'S',8);							//	초기화 벡터
	...
	public function xor16(&$t, $x1, $x2) {
		$t[0]					=	(int)$x1[0]  ^ (int)$x2[0];
		$t[1]					=	(int)$x1[1]  ^ (int)$x2[1];
		$t[2]					=	(int)$x1[2]  ^ (int)$x2[2];
		$t[3]					=	(int)$x1[3]  ^ (int)$x2[3];
		$t[4]					=	(int)$x1[4]  ^ (int)$x2[4];
		$t[5]					=	(int)$x1[5]  ^ (int)$x2[5];
		$t[6]					=	(int)$x1[6]  ^ (int)$x2[6];
		$t[7]					=	(int)$x1[7]  ^ (int)$x2[7];
		$t[8]					=	(int)$x1[8]  ^ (int)$x2[8];
		$t[9]					=	(int)$x1[9]  ^ (int)$x2[9];
		$t[10]					=	(int)$x1[10] ^ (int)$x2[10];
		$t[11]					=	(int)$x1[11] ^ (int)$x2[11];
		$t[12]					=	(int)$x1[12] ^ (int)$x2[12];
		$t[13]					=	(int)$x1[13] ^ (int)$x2[13];
		$t[14]					=	(int)$x1[14] ^ (int)$x2[14];
		$t[15]					=	(int)$x1[15] ^ (int)$x2[15];
	}
